...
│
├── auth/
│   └── global-setup.js        # Handles one-time login and saves auth state
│
├── pages/
│   ├── InventoryPage.js       # Inventory page actions & locators
│   └── CartPage.js            # Cart page actions & locators
│
├── tests/
│   └── addSecondCheapestItem.spec.js  # Main test scenario
│
├── storage/
...
### 2️⃣ Global Authentication (Storage State)
...
```
tests/
 └── addSecondCheapestItem.spec.js
```

---

### 4️⃣ Debugging Support
